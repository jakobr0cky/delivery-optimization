...
app.post('/example', (req, res) => {
  console.log('bodyyyyyyy'+JSON.stringify(req.body));

  getCoordinates(req.body.adress).then(coordinates =>{
    res.status(200).json({ message: 'POST request received successfully','coordinates':coordinates });
    return;
  })
